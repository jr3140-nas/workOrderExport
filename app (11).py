...
def _create_detail_table_figures(
    ...
    #   Work Order #  : 6%  (0.06)
    #   Sum of Hours  : 5%  (0.05)
    #   Type          : 12% (0.12) – widened to accommodate type names
    #   CC            : 3%  (0.03) – cost center column
    #   Description   : 19% (0.19) – reduced by 1% to fit cost center
    #   Problem       : 37% (0.37) – reduced to keep total at 100%
    # These values sum to 1.0 and correspond to the column order produced
    # by ``_df_for_pdf``: Name, Work Order #, Sum of Hours, Type, CC,
    # Description, Problem.
    col_widths = [0.18, 0.06, 0.05, 0.12, 0.03, 0.19, 0.37]
