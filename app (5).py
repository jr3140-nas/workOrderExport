...
def build_pdf(
    ...
    with PdfPages(buffer) as pdf:
        ...
        # Title page heading
        fig_title.text(0.5, 0.6, "Daily MS Work Order Log", fontsize=24, ha="center")
...
# log of work orders.
st.set_page_config(page_title="Daily MS Work Order Log", layout="wide")
st.title("Daily MS Work Order Log")
